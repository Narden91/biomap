...
import { Users, GraduationCap, MapPin, ExternalLink, Mail } from 'lucide-react';

// Memoized card component - prevents re-render when parent updates
const OrganizerCard = memo(({ name, role, title, affiliation, bio, imageUrl, profileUrl, email }) => (
